...
<Meta title='Components/v2/Alert' parameters={{ options: { showToolbar: true } }} />
...
The default Alert component showing info Card.
		...
		{() => {
			...
			return (
				<ThemedContainer theme='light'>
					...
					<Alert ref={alertRef} variant='card' theme='light' />
				</ThemedContainer>
			);
		}}
	</Story>
