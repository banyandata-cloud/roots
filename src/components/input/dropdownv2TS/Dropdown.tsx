...
const Dropdown = forwardRef<DropdownRef, DropdownProps>(function Dropdown(props, inputRef) {
	...
	// 		// Create a custom target type that includes the properties we need
	// 		interface CustomEventTarget extends EventTarget {
	// 			value: string;
	// 			name?: string;
	// 		}

	// 		// Create a custom synthetic event type
	// 		interface CustomSyntheticEvent extends React.SyntheticEvent {
	// 			target: CustomEventTarget;
	// 		}

	// 		// Create a new target object with our custom properties
	...
	// const onNavigate = (child: ReactElement, selected: boolean) => {
	...
	//       onChange(clonedEvent, appliedMultiUncontrolledValue || []);
	//       return;
	//     }

	//     onChange(clonedEvent, uncontrolledValue);
	//   };
