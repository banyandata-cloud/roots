...
export const getCrossIcon = () => {
	return `
		<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M7.79297 3.55176L3.79297 7.55176M3.79297 3.55176L7.79297 7.55176" stroke="#E40000" stroke-linecap="round" stroke-linejoin="round"/>
		</svg>
	`;
};

export const getExcludeIcon = () => {
    return `
        <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" width="12" height="12" rx="6" fill="white" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.59091 3H3.5V6.91304H5.40906V9.00008H9.49997V5.08704H7.59091V3ZM7.59091 5.08704H5.40906V6.91304H7.59091V5.08704Z" fill="black"/>
        </svg>
    `;
};
