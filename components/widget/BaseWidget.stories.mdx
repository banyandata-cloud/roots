			...
			return (
				<ThemedContainer
					...
					<BaseWidget
						...
						<Map v2 loading={true} theme={theme} cluster={false} coordinates={coords} />
					</BaseWidget>
				</ThemedContainer>
			);
		}}
...
<ToggleIframeContainer>
	<iframe
		src='https://codesandbox.io/s/dazzling-torvalds-kwr7yy?file=/src/App.js'
