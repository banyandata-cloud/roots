...
import ToggleIframeContainer from '../helpers/toggleIframeContainer/ToggleIframeContainer'
...
<iframe
	src='https://codesandbox.io/s/condescending-grass-6y725l?file=/src/App.js'
