...
<Meta title='Components/AlertV2' parameters={{ options: { showToolbar: true } }} />
		...
		{() => {
			...
			const toggle = () => {
				funs.alert({
					title: 'Information',
					description:
						'BasicInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfo InfoInfoInfoInfoInfoInfooInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInfoInf',
					type: 'info',
				});
			};
			return (
